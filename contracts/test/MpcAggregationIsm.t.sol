...
import {IAggregationIsm} from "node_modules/@hyperlane-xyz/core/contracts/interfaces/isms/IAggregationIsm.sol";
import {MpcAggregationIsmFactory} from "./MpcIsmFactory.sol";
import {TestIsm, ThresholdTestUtils} from "./IsmTestUtils.sol";

contract MpcAggregationIsmTest is Test {
    using Strings for uint256;
    using Strings for uint8;

    string constant fixtureKey = "fixture";

    MpcAggregationIsmFactory factory;
    IAggregationIsm ism;

    function setUp() public {
        factory = new MpcAggregationIsmFactory();
    }
